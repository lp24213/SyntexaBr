#!/usr/bin/env python3
"""Train tokenizer, model, and test inference."""
import sys
...
trainer = SyntexaFoundationTrainer(pretrain_cfg)
trainer.train(steps_per_epoch=50)
print('Pretrain done')

# 4) SFT on PI data
trainer.train_sft('data/syntexa_sft.jsonl', epochs=20, steps_per_epoch=100)
print('SFT done')
