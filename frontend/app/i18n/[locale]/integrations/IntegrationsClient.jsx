...
export default function IntegrationsClient({ locale }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      >
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-[#1a1c1e] mb-2">Integrações</h1>
          <p className="text-[#64748b] text-sm">
            Conecte suas contas Meta (WhatsApp, Instagram, Facebook), TikTok e gerencie com IA
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-[rgba(15,23,42,0.08)] p-6">
          {activeTab === "whatsapp" && (
            <div>
              ...
              <p className="text-[#64748b] mb-4">
                Conecte sua conta WhatsApp Business para gerenciar conversas com IA integrada.
              </p>
              {connected ? (
          ...
          {activeTab === "instagram" && (
            <div>
              ...
              <p className="text-[#64748b] mb-4">
                Integre seu Instagram para responder mensagens com IA.
              </p>
          ...
          {activeTab === "facebook" && (
            <div>
              ...
              <p className="text-[#64748b] mb-4">
                Integre seu Facebook para gerenciar mensagens com IA.
              </p>
          ...
          {activeTab === "tiktok" && (
            <div>
              <h2 className="text-lg font-semibold mb-4">TikTok Business</h2>
              <p className="text-[#64748b] mb-4">
                Integre sua conta TikTok Business para gerenciar campanhas e conteúdo com IA.
              </p>
              ...
              <div className="bg-[#f9f9f9] border border-[rgba(15,23,42,0.08)] rounded-lg p-4 mb-4">
                <p className="text-sm text-[#64748b] mb-1"><strong>Todos os locales suportados:</strong></p>
